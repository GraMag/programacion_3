...
class Auto
{
    ...
    public function __construct($marca, $color, $precio = 0, $fecha = ""){
        ...
        $this->_color  = $color;
        $this->_precio = $precio;
        $this->_fecha  = ($fecha == "") ? date("d/m/y") : $fecha;            
    }
    ...
    public static function MostrarAuto($auto){
        echo("<u>Marca:</u> "       . $auto->_marca);
        echo("<br><u>Color:</u> "   . $auto->_color);
        echo("<br><u>Precio:</u> $" . $auto->_precio);
        echo("<br><u>Fecha:</u> "   . $auto->_fecha);
    }
    ...
    public static function Add($auto1, $auto2){
        if($auto1->Equals($auto2) && $auto1->_color == $auto2 -> _color){
            ...
            echo("Los autos deben ser de la misma marca y color: Error ");
            return 0;
        }
    }
}